...
#pragma warning disable CS8629 // Nullable value type may be null.
            CreateMap<Application, drr_application>(MemberList.None)
                ...
                .ForMember(dest => dest.drr_SubmitterContact, opt => opt.MapFrom(src => src.AuthorizedRepresentative))
                ...
                .ForMember(dest => dest.drr_reasoncontigencymismatch, opt => opt.MapFrom(src => src.ContingencyComments))
                ...
                .ForMember(dest => dest.AuthorizedRepresentative, opt => opt.MapFrom(src => src.drr_SubmitterContact))
                ...
                .ForMember(dest => dest.OtherFunding, opt => opt.MapFrom(src => src.drr_application_fundingsource_Application.Where(c => c.statecode == (int)EntityState.Active)))
                ...
                //Permits Regulations & Standards - 7
                .ForMember(dest => dest.Permits, opt => opt.MapFrom(src => src.drr_drr_application_drr_permitslicensesandauthorizations_Application.Where(c => c.statecode == (int)EntityState.Active)))
                ...
                .ForMember(dest => dest.ContingencyComments, opt => opt.MapFrom(src => src.drr_reasoncontigencymismatch))
...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
            ...
            CreateMap<BcGovDocument, bcgov_documenturl>(MemberList.None)
                ...
                .ForMember(dest => dest.CreatedOn, opt => opt.MapFrom(src => src.createdon.HasValue ? src.createdon.Value.UtcDateTime : (DateTime?)null))
            ;
        }
