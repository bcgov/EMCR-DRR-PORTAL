...
#pragma warning disable CS8604 // Possible null reference argument.
            CreateMap<ClaimDetails, drr_projectclaim>(MemberList.None)
                ...
                .ForMember(dest => dest.drr_interestearned, opt => opt.MapFrom(src => src.UpFrontPaymentInterest))
            ...
            CreateMap<ForecastDetails, drr_projectbudgetforecast>(MemberList.None)
                ...
                .ForMember(dest => dest.DateApproved, opt => opt.MapFrom(src => src.drr_dateapproved.HasValue ? src.drr_dateapproved.Value.UtcDateTime : (DateTime?)null))
                .ForMember(dest => dest.Total, opt => opt.MapFrom(src => src.drr_total))
            ...
            .ValidateMemberList(MemberList.Destination)
                .ForMember(dest => dest.Id, opt => opt.MapFrom(src => src.drr_budgetforecastreportitemid))
            ...
            CreateMap<WorkplanActivityDetails, drr_projectworkplanactivity>(MemberList.None)
                ...
                .ForMember(dest => dest.drr_awarddateforcontractawardstatus, opt => opt.MapFrom(src => src.ContractAwardDate.HasValue ? src.ContractAwardDate.Value.ToUniversalTime() : (DateTimeOffset?)null))
                .ForMember(dest => dest.drr_plannedawarddateforcontractawardstatus, opt => opt.MapFrom(src => src.PlannedContractAwardDate.HasValue ? src.PlannedContractAwardDate.Value.ToUniversalTime() : (DateTimeOffset?)null))
                .ForMember(dest => dest.drr_awarddateforpermittoconstruct, opt => opt.MapFrom(src => src.AwardPermitToConstructDate.HasValue ? src.AwardPermitToConstructDate.Value.ToUniversalTime() : (DateTimeOffset?)null))
                .ForMember(dest => dest.drr_plannedawarddateforpermittoconstruct, opt => opt.MapFrom(src => src.PlannedAwardPermitToConstructDate.HasValue ? src.PlannedAwardPermitToConstructDate.Value.ToUniversalTime() : (DateTimeOffset?)null))
            ...
            CreateMap<drr_projectworkplanactivity, WorkplanActivityDetails>(MemberList.None)
                ...
                .ForMember(dest => dest.ContractAwardDate, opt => opt.MapFrom(src => src.drr_awarddateforcontractawardstatus.HasValue ? src.drr_awarddateforcontractawardstatus.Value.UtcDateTime : (DateTime?)null))
                .ForMember(dest => dest.PlannedContractAwardDate, opt => opt.MapFrom(src => src.drr_plannedawarddateforcontractawardstatus.HasValue ? src.drr_plannedawarddateforcontractawardstatus.Value.UtcDateTime : (DateTime?)null))
                .ForMember(dest => dest.AwardPermitToConstructDate, opt => opt.MapFrom(src => src.drr_awarddateforpermittoconstruct.HasValue ? src.drr_awarddateforpermittoconstruct.Value.UtcDateTime : (DateTime?)null))
                .ForMember(dest => dest.PlannedAwardPermitToConstructDate, opt => opt.MapFrom(src => src.drr_plannedawarddateforpermittoconstruct.HasValue ? src.drr_plannedawarddateforpermittoconstruct.Value.UtcDateTime : (DateTime?)null))
