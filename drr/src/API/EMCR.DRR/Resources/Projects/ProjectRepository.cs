    ...
    public class ProjectRepository : IProjectRepository
    {
        ...
        private static async Task ParallelLoadRequests(DRRContext ctx, drr_project project, CancellationToken ct)
        {
            ...
            await project.drr_project_drr_request_ProjectId.ForEachAsync(5, async request =>
            {
                ...
                if (request.drr_ProjectConditionId != null) request.drr_ProjectConditionId.drr_Condition = conditionTypes.SingleOrDefault(c => c.drr_conditiontypeid == request.drr_ProjectConditionId._drr_condition_value);
            });
        }
